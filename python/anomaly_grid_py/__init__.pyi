...
class AnomalyDetector:
    ...
    def predict(self, X: Union[List[List[str]], np.ndarray], threshold: float = ...) -> np.ndarray:
        """Predict anomalies."""
        ...
    
    def detect_anomalies(self, X: Union[List[List[str]], np.ndarray], threshold: float = ...) -> List[Any]:
