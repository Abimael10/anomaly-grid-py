...
class AnomalyDetector:
    ...
    def predict(self, X: Union[List[List[str]], np.ndarray], 
    ...
    def predict_proba_with_padding(self, X: Union[List[List[str]], np.ndarray], 
                                  padding_token: str = "<PAD>") -> np.ndarray:
        """
    ...
    def _validate_sequences(self, X: Union[List[List[str]], np.ndarray], allow_single_element: bool = False) -> Union[List[List[str]], np.ndarray]:
