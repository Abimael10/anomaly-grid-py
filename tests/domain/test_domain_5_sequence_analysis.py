...
class TestSequenceAnalysis:
    ...
    def setup_method(self):
        ...
        all_patterns = cyclic_patterns + linear_patterns + branching_patterns + repetitive_patterns
    ...
    def test_5_1_pattern_recognition_and_learning(self):
        ...
        for i, (pattern, score) in enumerate(zip(trained_patterns, trained_scores)):
            ...
            assert score < 0.3, f"Trained {pattern_type} pattern has high anomaly score: {score:.6f}"
        ...
        for i, (pattern, score) in enumerate(zip(pattern_variations, variation_scores)):
            variation_type = ['Incomplete Cyclic', 'Shortened Linear', 'New Branch', 'Shorter Repetitive'][i]
    ...
    def test_5_3_temporal_pattern_detection(self):
        ...
        position_tests = [
            ...
            ([base_seq[2], base_seq[0], base_seq[4], base_seq[1], base_seq[3]], "Shuffled")
        ]
    ...
    def test_5_6_sequence_statistics_and_properties(self):
        ...
        for sequence, description in statistical_tests:
            ...
            print(f"      {description:15s}: score = {score:.6f}, diversity = {diversity_ratio:.3f}")
    ...
    def test_5_7_anomaly_localization(self):
        ...
        print(f"    Score progression: {' -> '.join(f'{s:.3f}' for s in incremental_scores)}")
